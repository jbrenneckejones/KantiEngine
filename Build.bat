...
set CommonCompilerFlags=-D _CRT_SECURE_NO_WARNINGS=1 -D _ITERATOR_DEBUG_LEVEL=2 -D KANTI_INTERNAL=1 -D KANTI_SLOW=1 -D KANTI_WIN32=1 %VulkanCompilerFlags% %CommonCompilerFlags% 
set CommonLinkerFlags=-incremental:no -opt:ref User32.lib Winmm.lib Ole32.lib %VulkanLocation% 
